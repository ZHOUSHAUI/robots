...
m33=I2_11 + (l2^2*m2)/4; 
rhs1=(I2_12*w2_x^2*cos(q2 + q3))/2 - T1 + (I2_12*w3_x^2*cos(q2 + q3))/2 + (I2_21*w2_x^2*cos(q2 + q3))/2 + (I2_21*w3_x^2*cos(q2 + q3))/2 - (I2_13*w2_x^2*sin(q2 + q3))/2 - (I2_13*w3_x^2*sin(q2 + q3))/2 - (I2_31*w2_x^2*sin(q2 + q3))/2 - (I2_31*w3_x^2*sin(q2 + q3))/2 + (I1_12*w2_x^2*cos(q2))/2 + (I1_21*w2_x^2*cos(q2))/2 - (I1_13*w2_x^2*sin(q2))/2 - (I1_31*w2_x^2*sin(q2))/2 + I2_22*w2_x*w1_z*sin(2*q2 + 2*q3) + I2_22*w1_z*w3_x*sin(2*q2 + 2*q3) - I2_33*w2_x*w1_z*sin(2*q2 + 2*q3) - I2_33*w1_z*w3_x*sin(2*q2 + 2*q3) + I2_12*w2_x*w3_x*cos(q2 + q3) + I2_21*w2_x*w3_x*cos(q2 + q3) - I2_13*w2_x*w3_x*sin(q2 + q3) - I2_31*w2_x*w3_x*sin(q2 + q3) + I1_23*w2_x*w1_z*cos(2*q2) + I1_32*w2_x*w1_z*cos(2*q2) + I1_22*w2_x*w1_z*sin(2*q2) - I1_33*w2_x*w1_z*sin(2*q2) + I2_23*w2_x*w1_z*cos(2*q2 + 2*q3) + I2_23*w1_z*w3_x*cos(2*q2 + 2*q3) + I2_32*w2_x*w1_z*cos(2*q2 + 2*q3) + I2_32*w1_z*w3_x*cos(2*q2 + 2*q3) + (l1^2*m1*w2_x*w1_z*sin(2*q2))/4 + l1^2*m2*w2_x*w1_z*sin(2*q2) + (l2^2*m2*w2_x*w1_z*sin(2*q2 + 2*q3))/4 + (l2^2*m2*w1_z*w3_x*sin(2*q2 + 2*q3))/4 - (l1*l2*m2*w1_z*w3_x*sin(q3))/2 + l1*l2*m2*w2_x*w1_z*sin(2*q2 + q3) + (l1*l2*m2*w1_z*w3_x*sin(2*q2 + q3))/2; 
rhs2=(I1_33*w1_z^2*sin(2*q2))/2 - (I1_23*w1_z^2*cos(2*q2))/2 - (I1_32*w1_z^2*cos(2*q2))/2 - (I1_22*w1_z^2*sin(2*q2))/2 - T2 - g*m2*((l2*sin(q2 + q3))/2 + l1*sin(q2)) - (I2_23*w1_z^2*cos(2*q2 + 2*q3))/2 - (I2_32*w1_z^2*cos(2*q2 + 2*q3))/2 - (I2_22*w1_z^2*sin(2*q2 + 2*q3))/2 + (I2_33*w1_z^2*sin(2*q2 + 2*q3))/2 - (g*l1*m1*sin(q2))/2 - (l1^2*m1*w1_z^2*sin(2*q2))/8 - (l1^2*m2*w1_z^2*sin(2*q2))/2 - (l2^2*m2*w1_z^2*sin(2*q2 + 2*q3))/8 - (l1*l2*m2*w3_x^2*sin(q3))/2 - (l1*l2*m2*w1_z^2*sin(2*q2 + q3))/2 - l1*l2*m2*w2_x*w3_x*sin(q3); 
rhs3=(I2_33*w1_z^2*sin(2*q2 + 2*q3))/2 - (I2_23*w1_z^2*cos(2*q2 + 2*q3))/2 - (I2_32*w1_z^2*cos(2*q2 + 2*q3))/2 - (I2_22*w1_z^2*sin(2*q2 + 2*q3))/2 - T3 - (g*l2*m2*sin(q2 + q3))/2 - (l2^2*m2*w1_z^2*sin(2*q2 + 2*q3))/8 + (l1*l2*m2*w2_x^2*sin(q3))/2 + (l1*l2*m2*w1_z^2*sin(q3))/4 - (l1*l2*m2*w1_z^2*sin(2*q2 + q3))/4; 
