...
KE=(I1_11*w1_x^2)/2 + (I2_11*w1_x^2)/2 + (I2_11*w2_x^2)/2 + I2_11*w1_x*w2_x + (m1*w1_x^2*abs(l1)^2)/8 + (m2*w1_x^2*abs(l1)^2)/2 + (m2*w1_x^2*abs(l2)^2)/8 + (m2*w2_x^2*abs(l2)^2)/8 + (m2*w1_x*w2_x*abs(l2)^2)/4 + (l1*m2*w1_x^2*conj(l2)*cos(q2))/4 + (l2*m2*w1_x^2*conj(l1)*cos(q2))/4 + (l1*m2*w1_x*w2_x*conj(l2)*cos(q2))/4 + (l2*m2*w1_x*w2_x*conj(l1)*cos(q2))/4;
PE=g*m2*(conj(l1)*cos(q1) + (cos(q1 + q2)*conj(l2))/2) + (g*m1*conj(l1)*cos(q1))/2;
end
